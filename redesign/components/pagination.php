<?php
$routeKey = isset($routeKey) ? $routeKey : 'gallery';
$fragment = isset($fragment) ? $fragment : null;
$ariaLabel = isset($ariaLabel) ? $ariaLabel : localized_text($locale, ['tr' => 'Galeri sayfaları', 'en' => 'Gallery pages', 'de' => 'Galerieseiten', 'es' => 'Páginas de la galería']);
?>
<?php if ($pageCount > 1): ?>

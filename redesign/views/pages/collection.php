...
<section class="collection-intro"><div class="shell collection-intro__inner"><p><?= e($locale === 'tr' ? 'Ürün seçkisi' : 'Product selection') ?></p><ul><?php foreach ($interior['categories'] as $category): ?><li><?= e($category) ?></li><?php endforeach; ?></ul></div></section>

        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>Yönetici Ayarları</h5>
                    <a href="index.php?sayfa=yoneticiler&islem=ekle" class="btn btn-success dim pull-right" style="margin-top: -8px;"><i class="fa fa-plus" aria-hidden="true"></i></a>
                </div>
                        ...
                        ?>
                            <tr id="item-<?php echo $row->id;?>">
                                ...
                                <td style="vertical-align: middle;" class="tooltip-demo">
                                    <a href="?sayfa=yoneticiler&islem=duzenle&id=<?php echo $row->id; ?>" class="btn btn-sm waves-effect btn-default m-b-5" data-toggle="tooltip" data-placement="top" title="Düzenle"><i class="fa fa-edit"></i></a>
                                    <a href="?sayfa=yoneticiler&islem=sil&id=<?php echo $row->id; ?>" class="btn btn-sm waves-effect btn-default m-b-5" onclick="return confirm('Yöneticiyi silmek istediğinize eminmisiniz?');" data-toggle="tooltip" data-placement="top" title="Sil"><i class="fa fa-times"></i></a>
                                </td>
                            </tr>
                        <?
                        }

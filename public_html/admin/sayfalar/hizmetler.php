                        ...
                        ?>
                            <tr id="item-<?php echo $row->id;?>">
                                ...
                                <td style="vertical-align: middle;" class="tooltip-demo">
                                     <a href="?sayfa=hizmetler&islem=duzenle1&id=<?php echo $row->id; ?>" class="btn btn-sm waves-effect btn-default m-b-5" data-toggle="tooltip" data-placement="top" title="Düzenle"><i class="fa fa-edit"></i></a>
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
						...
						<div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="uzunaciklama" class="form-control ckeditor" style="width:1050px; height:200px;"></textarea>
                                </div>
                            </div>
							<div class="col-sm-6">
                                <div class="form-group">
                                    <label class="control-label">Açıklama EN</label>
                                    <textarea name="uzunaciklamaEN" class="form-control ckeditor" style="width:1050px; height:200px;"></textarea>
                                </div>
                            </div>
						...
						<div class="row">						
                            <div class="col-sm-3">
                                <div class="form-group">
                                <label class="control-label">Ürün Kataloğu TR (Linki Yazınız)</label>
                                    <input type="text" name="katalog" id="katalog" class="form-control">
                                </div>
                            </div>
							<div class="col-sm-3">
                                <div class="form-group">
                                <label class="control-label">Ürün Kataloğu EN (Linki Yazınız)</label>
                                    <input type="text" name="katalogEN" id="katalogEN" class="form-control">
                                </div>
                            </div>
						</div>
						...
						<div class="ibox-title ilave">
							<h5 style="color: #fff; font-size: 18px;">Toplu Resim Yükleme Alanı</h5>
						</div>
...
$SID = $Oturum;
$guncelle = $dw->update('hizmetresimler', $user, array('sessionID = ?'), array($SID), array('configKey' => 'secondaryDB'));   
...
//* Resimler
  ...
  <form action="index.php?sayfa=hizmetler&islem=duzenlendi1" method="post" enctype="multipart/form-data">
    <div class="row">
        ...
        <div class="ibox float-e-margins">
            <div class="ibox-content">
						...
						<div class="row">						
                            <div class="col-sm-3">
                                <div class="form-group">
                                <label class="control-label">Hizmet Kataloğu TR (Linki Yazınız)</label>
                                    <input type="text" name="katalog" id="katalog" class="form-control" value="<?php echo $veri->katalog;?>">
                                </div>
                            </div>
							<div class="col-sm-3">
                                <div class="form-group">
                                <label class="control-label">Hizmet Kataloğu EN (Linki Yazınız)</label>
                                    <input type="text" name="katalogEN" id="katalogEN" class="form-control" value="<?php echo $veri->katalogEN;?>">
                                </div>
                            </div>
						</div>
						...
						<div class="row">
							...
							<div class="col-sm-2">
								...
								<div class="form-group">
									...
									<img width="250px" height="250px" src="../yukleme/hizmetler/<?php echo $veri->resim; ?>">
								</div>
								<div class="form-group">
									<a class="btn btn-danger" href="index.php?sayfa=hizmetler&islem=resimsil1&id=<?php echo $veri->id;?>" onclick="return confirm('Resmi silmek istediğinize emin misiniz?');">Resmi Sil</a>
								</div>
							</div>
							<?php  } else { ?> 
...
$kontrol = $dw->getRow('SELECT * FROM hizmetresimler WHERE urunid = ?', array('bindValues' => array($id)));
$varmi = $dw->numRows(); 
...
$sguncelle = $dw->update('hizmetler', $gveri, array('id = ?'), array($id), array('configKey' => 'secondaryDB'));   
}
...
$sil = '../yukleme/hizmetler/'.$kategoriveri->resim;
@unlink($sil);  
$guncelle = $dw->update('hizmetler', $veri, array('id = ?'), array($id), array('configKey' => 'secondaryDB'));
?>
<div class="alert alert-success">Bilgiler Güncellendi!<br>Bilgiler başarıyla güncellendi. Lütfen bekleyin yönlendiriliyorsunuz.</div>
<meta http-equiv="refresh" content="2; URL=index.php?sayfa=hizmetler&islem=duzenle1&id=<?php echo $id; ?>">
...
$kategoriveri = $dw->getRow('SELECT * FROM hizmetler WHERE id = ?', array('bindValues' => array($id)));
$resimsil = '../yukleme/hizmetler/'.$kategoriveri->resim;
 @unlink($resimsil); 
$sil = $dw->delete('hizmetler', array('id = ?'), array($id), array('configKey' => 'secondaryDB'));

          $rsorgu = "Select * from hizmetresimler WHERE urunid='$id'";
          $rlist = $dw->getResults(''.$rsorgu.'');
          foreach($rlist as $rrow){
            $resimsil2 = '../yukleme/hizmetler/'.$rrow->resim;
            @unlink($resimsil2); 
            } 
$sil2 = $dw->delete('hizmetresimler', array('urunid = ?'), array($id), array('configKey' => 'secondaryDB'));
?>

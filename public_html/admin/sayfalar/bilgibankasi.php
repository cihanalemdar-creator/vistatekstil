        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>Bilgi Bankası Ayarları</h5><!--Ekle Butonu oluşturuluyor.-->
                    <a href="index.php?sayfa=bilgibankasi&islem=ekle" class="btn btn-success dim pull-right" style="margin-top: -8px;"><i class="fa fa-plus" aria-hidden="true"></i></a>
                </div>
                <div class="ibox-content">
                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                <th width="90%">Bilgi Bankası Başlık</th>
                        ...
                        <tbody id="sortable">
                        <?php
                        $sorgu = "SELECT * FROM bilgibankasi order by id desc ";
                        $list1 = $dw->getResults(''.$sorgu.'');
                        $total_records = $dw->numRows();
                        $pager_url = '?sayfa=bilgibankasi&page='; 
                        $scroll_page = 5; 
                        $per_page = 10; 
                        ...
                        ?>
                            <tr id="item-<?php echo $row->id;?>">
                                ...
                                <td style="vertical-align: middle;" class="tooltip-demo">
                                     <a href="?sayfa=bilgibankasi&islem=duzenle1&id=<?php echo $row->id; ?>" class="btn btn-sm waves-effect btn-default m-b-5" data-toggle="tooltip" data-placement="top" title="Düzenle"><i class="fa fa-edit"></i></a>
                                   <a href="?sayfa=bilgibankasi&islem=sil&id=<?php echo $row->id; ?>" class="btn btn-sm waves-effect btn-default m-b-5" onclick="return confirm('Bilgileri silmek istediğinize emin misiniz?');" data-toggle="tooltip" data-placement="top" title="Sil"><i class="fa fa-times"></i></a><!--Sil butonu oluşturuluyor-->
                                </td>
                            </tr>
                        <?
                        }
...
function ResimDuzenSil2(S) {
    ...
    <div class="row">
        <form action="index.php?sayfa=bilgibankasi&islem=eklendi" method="post" enctype="multipart/form-data">
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>Bilgi Bankası Ekle</h5>
                </div>
                <div class="ibox-content">
						<div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <label class="control-label">Başlık Adı TR</label>
							...
							<div class="col-sm-6">
                                <div class="form-group">
                                <label class="control-label">Başlık Adı EN</label>
							...
							<div class="col-sm-6">
                                <div class="form-group">
                                <label class="control-label">Başlık Adı AR</label>
                                    <input type="text" name="baslikAR" id="baslikAR" class="form-control" required>
                                </div>
                            </div>	
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="aciklama" class="form-control ckeditor" style="width:1050px; height:200px;" required></textarea>
                                </div>
                            </div>
							...
							<div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="aciklamaEN" class="form-control ckeditor" style="width:1050px; height:200px;" required></textarea>
                                </div>
                            </div>
							
							<div class="col-sm-6">
                                <div class="form-group">
                                    <label class="control-label">Açıklama AR</label>
                                    <textarea name="aciklamaAR" class="form-control ckeditor" style="width:1050px; height:200px;" required></textarea>
                                </div>
                            </div>
							...
							<div class="col-sm-6">
								...
								<label class="control-label">Kapak Resmi</label>
								 <div class="alert alert-info">
									  ...
									  Slaytın bozulmaması ve düzgün görünmesi için 360px X 216px boyutlu fotoğraf yükleyiniz.<br>
								 </div>
...
$upload->image_x = 360;
$upload->image_y = 216;
$upload->process("../yukleme/bilgibankasi");
...
$veri = array(
	...
	'aciklamaAR' => $aciklamaAR,
    'resim' => $Resim,
);


$YoneticiID = $dw->insert('bilgibankasi', $veri, array('configKey' => 'secondaryDB'));
...
<meta http-equiv="refresh" content="2; URL=index.php?sayfa=bilgibankasi">

<? 
}else if ( $islem =="duzenle1" )  {
$id = intval( $_GET[id] );    

$veri = $dw->getRow('SELECT * FROM bilgibankasi WHERE id = ?', array('bindValues' => array($id)));
?>
...
//* Resimler
  ...
  <form action="index.php?sayfa=bilgibankasi&islem=duzenlendi1" method="post" enctype="multipart/form-data">
    <div class="row">
            ...
            <div class="ibox-content">
                    <div class="row">
							...
							<div class="col-sm-12">
								...
								<div class="form-group">
									...
									<img width="360px" height="216px" src="../yukleme/bilgibankasi/<?php echo $veri->resim; ?>">
								</div>
								<div class="form-group">
									<a class="btn btn-danger" href="index.php?sayfa=bilgibankasi&islem=resimsil1&id=<?php echo $veri->id;?>" onclick="return confirm('Resmi silmek istediğinize emin misiniz?');">Resmi Sil</a>
								</div>
							</div>
							<?php  } else { ?> 
                    ...
                    <div class="row">    
							...
							<div class="col-sm-6">
                                <div class="form-group">
                                <label class="control-label">Başlık Adı AR</label>
                                    <input type="text" name="baslikAR" id="baslikAR" class="form-control" value="<?php echo $veri->baslikAR;?>"required>
                                </div>
                            </div>	
					</div>
					...
					<div class="row"> 
							...
							<div class="col-sm-6">
                                <div class="form-group">
                                    <label class="control-label">Detay AR</label>
                                    <textarea name="aciklamaAR" class="form-control ckeditor" style="width:1050px; height:200px;" required><?php echo $veri->aciklamaAR;?></textarea>
                                </div>
                            </div>
...
$guncelle = $dw->update('bilgibankasi', $veri, array('id = ?'), array($id), array('configKey' => 'secondaryDB'));
...
$sguncelle = $dw->update('bilgibankasi', $gveri, array('id = ?'), array($id), array('configKey' => 'secondaryDB'));   
}
...
$id = intval( $_GET[id] );
$kategoriveri = $dw->getRow('SELECT * FROM bilgibankasi WHERE id = ?', array('bindValues' => array($id)));

$veri = array(
   'resim' => ""
);
$sil = '../yukleme/bilgibankasi/'.$kategoriveri->resim;
@unlink($sil);  
$guncelle = $dw->update('bilgibankasi', $veri, array('id = ?'), array($id), array('configKey' => 'secondaryDB'));
?>
<div class="alert alert-success">Bilgiler Güncellendi!<br>Bilgiler başarıyla güncellendi. Lütfen bekleyin yönlendiriliyorsunuz.</div>
<meta http-equiv="refresh" content="2; URL=index.php?sayfa=bilgibankasi&islem=duzenle1&id=<?php echo $id; ?>">
...
$kategoriveri = $dw->getRow('SELECT * FROM bilgibankasi WHERE id = ?', array('bindValues' => array($id)));
$resimsil = '../yukleme/bilgibankasi/'.$kategoriveri->resim;
 @unlink($resimsil); 
$sil = $dw->delete('bilgibankasi', array('id = ?'), array($id), array('configKey' => 'secondaryDB'));

          $rsorgu = "Select * from projeresimler WHERE urunid='$id'";
          $rlist = $dw->getResults(''.$rsorgu.'');
          foreach($rlist as $rrow){
            $resimsil2 = '../yukleme/bilgibankasi/'.$rrow->resim;
            @unlink($resimsil2); 
            } 
...
$id = intval( $_GET[id] );
          ...
          $rlist = $dw->getResults(''.$rsorgu.'');
          foreach($rlist as $rrow){
            $resimsil2 = '../yukleme/urunresimler/'.$rrow->resim;
            @unlink($resimsil2); 
            } 
$sil2 = $dw->delete('urunresimler', array('urunid = ?'), array($id), array('configKey' => 'secondaryDB'));
?>

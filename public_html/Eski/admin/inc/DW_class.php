<?php
    ...
    Class DWDB {
        ...
        private function assignErrorMsgs() {
            $this->msg = array(
                0 => "DWDB Error: function createInstance(): database config key's value data type is incorrect.",
                1 => "DWDB Error: function createInstance(): database config key's value is empty.",
                2 => "DWDB Error: function createInstance(): database config key's temporary value is empty.",
                3 => "DWDB Error: function createInstance(): mysql username is incorrect.",
                4 => "DWDB Error: function createInstance(): mysql user password is incorrect.",
                5 => "DWDB Error: function createInstance(): mysql hostname is incorrect.",
                6 => "DWDB Error: function createInstance(): mysql database is incorrect.",
                7 => "DWDB Error: function createInstance(): mysql char set is incorrect.",
                8 => "DWDB Error: Sql query is empty or incorrect.",
                9 => "DWDB Error: Sql query is incorrect.",
                10 => "DWDB Error: Table parameter's value is empty or incorrect.",
                11 => "DWDB Error: Data parameter's value is empty or incorrect.",
            );
        }

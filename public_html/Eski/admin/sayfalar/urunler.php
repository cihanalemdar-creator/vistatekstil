							...
							<div class="col-sm-6">
								...
								<label class="control-label">Ürün Kapak Resmi</label>
								 <div class="alert alert-info">
									  ...
									  Slaytın bozulmaması ve düzgün görünmesi için 800px X 800px boyutlu fotoğraf yükleyiniz.<br>
								 </div>
        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                    <div class="row">
							...
							<div class="col-sm-12">
								...
								<div class="form-group">
									...
									<img width="200px" height="200px" src="../yukleme/urunler/<?php echo $veri->resim; ?>">
								</div>
								<div class="form-group">
					...
					<div class="row"> 
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label class="control-label">Ürün Detay TR</label>
							...
							<div class="col-sm-6">
                                <div class="form-group">
                                    <label class="control-label">Ürün Detay EN</label>

	 ...
	 <div class="breadcumb-wrapper " data-bg-src="yukleme/anasayfa/8.jpg" data-overlay="black" data-opacity="8">
        <div class="container">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title"><?php echo dil('Galeri','Gallery');?></h1>
                <ul class="breadcumb-menu">
                    <li><a href="<?php echo $iletisimveri->baseurl; ?>"><?php echo dil('Anasayfa','Home');?></a></li>
					<li><a href="galeri"><?php echo dil('Galeri','Gallery');?></a></li>
                </ul>
            </div>
        </div>
    </div>
				...
				<div class="col-md-6 col-lg-4 cat1">
                    <div class="project-card style-2">
                        <div class="project-img">
                            <img src="yukleme/galeri/<?php echo $rrow->resim; ?>" alt="image">
                        </div>
                        <div class="project-content">
                            <a href="yukleme/galeri/<?php echo $rrow->resim; ?>" class="icon-btn popup-image" tabindex="-1"><i class="fa-light fa-arrow-up-right"></i></a>
                        </div>
                    </div>
                </div>				
